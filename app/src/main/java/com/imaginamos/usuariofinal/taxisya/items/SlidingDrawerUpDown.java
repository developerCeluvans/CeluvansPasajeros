...
public class SlidingDrawerUpDown extends ViewGroup {
	...
	public SlidingDrawerUpDown(Context context, AttributeSet attrs) {
	...
	public SlidingDrawerUpDown(Context context, AttributeSet attrs,
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.SlidingDrawerUpDown, defStyle, 0);

		int orientation = a.getInt(
				R.styleable.SlidingDrawerUpDown_direction,
				ORIENTATION_BTT);
		mVertical = (orientation == ORIENTATION_BTT || orientation == ORIENTATION_TTB);
		mBottomOffset = (int) a.getDimension(
				R.styleable.SlidingDrawerUpDown_bottomOffset, 0.0f);
		mTopOffset = (int) a.getDimension(
				R.styleable.SlidingDrawerUpDown_topOffset, 0.0f);
		mAllowSingleTap = a.getBoolean(
				R.styleable.SlidingDrawerUpDown_allowSingleTap, true);
		mAnimateOnClick = a.getBoolean(
				R.styleable.SlidingDrawerUpDown_animateOnClick, true);
		mInvert = (orientation == ORIENTATION_TTB || orientation == ORIENTATION_LTR);

		int handleId = a.getResourceId(
				R.styleable.SlidingDrawerUpDown_handle, 0);
		if (handleId == 0) {
		...
		int contentId = a.getResourceId(
				R.styleable.SlidingDrawerUpDown_content, 0);
		if (contentId == 0) {
			throw new IllegalArgumentException(
